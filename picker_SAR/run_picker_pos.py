"""Run SAR positive-window picker on fixed NPY shard datasets."""
import argparse
import json
import os
import re
...
from picker_pos import SARPositivePicker, configure_positive_picker, rows_to_csv
...
def main():
    ...
    picker = SARPositivePicker(args.ckpt_dir, args.ckpt_idx, args.gpu_idx)
