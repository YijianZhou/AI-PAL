"""Main function for offline stream picking with ResUNet.

The ResUNet model is loaded once in the main process.  Parallelism is handled
...
def main():
    ...
    run_picker = picker_module.RUN_Picker(args.ckpt_dir, args.ckpt_idx, args.gpu_idx)
