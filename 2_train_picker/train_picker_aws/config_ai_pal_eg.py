...
import data_pipeline_training_aws as training_data_pipeline


class Config(object):
  def __init__(self):
    # Shared waveform preprocessing and sample layout.
    self.samp_rate = 100
    self.win_len = 25
    self.win_stride = 2.5
    self.num_chn = 3
    ...
    self.load_station_stream = training_data_pipeline.load_station_stream
