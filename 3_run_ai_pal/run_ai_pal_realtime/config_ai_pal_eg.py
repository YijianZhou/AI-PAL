...
class Config(object):
  def __init__(self):
    ...
    self.reference_workflows = [  # Used only by the realtime workflow.
    ...
    self.enable_event_waveform_plot_ref = [0, 1]  # reference_workflows indexes
    self.save_filtered_event_waveforms = False

    # 6. Realtime service (unused by offline workflows)
    self.poll_interval_sec = 60
    self.max_files = 0
    self.max_runtime_sec = 0

    # 7. Training-sample construction
